        ...
        ScrollView {
            VStack {
                ...
                VStack(alignment: .leading) {
                    Text("Temperature")
                    Text("\(caseData.symptomValuesData.temperature)")
                        .font(.body)
                        .foregroundColor(.secondary)
                        .padding(.bottom)
                    Text("Heart Rate")
                    Text("\(caseData.symptomValuesData.heartRate)")
                        .font(.body)
                        .foregroundColor(.secondary)
                        .padding(.bottom)
                    Text("Respiratory Rate")
                    Text("\(caseData.symptomValuesData.respiratoryRate)")
                        .font(.body)
                        .foregroundColor(.secondary)
                        .padding(.bottom)
                    Text("Blood Pressure")
                    Text("\(caseData.symptomValuesData.bloodPressure)")
                        .font(.body)
                        .foregroundColor(.secondary)
                        .padding(.bottom)
                    Text("Oxygen Saturation")
                    Text("\(caseData.symptomValuesData.oxygenSaturation)")
                        .font(.body)
                        .foregroundColor(.secondary)
                }
